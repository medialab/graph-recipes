...
function drawFlowMatrix(attData) {
	// Compute crossings
	var crossings = []
	var v1
	var v2
	...
	var width = 2 * maxR * attData.values.length
	...
	dot.append("circle")
	  ...
	  .attr("cx", function(d) { return x(valueRanking[d.v1]) })
	  .attr("cy", function(d) { return y(valueRanking[d.v2]) })
	  .style("fill", 'rgba(120, 120, 120, 0.3)')

 dot.append('text')
	    .attr('x', function(d){ return x(valueRanking[d.v1]) })
	    .attr('y', function(d){ return y(valueRanking[d.v2]) + 4 })
